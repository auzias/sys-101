\section{Memory Management}
  ...
  \begin{frame}
    \frametitle{Q/A}
    \begin{itemize}
      \item For static relocation, where is stored the constant of the constant added? %base register: see slide Memory abstraction:address spaces
      ...
      \item When does a page fault occur? %process references an address that is not stored in the memory
